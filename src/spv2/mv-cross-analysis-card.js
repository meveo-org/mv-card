...
export class MvCrossAnalysisCard extends LitElement {
  ...
  static get styles() {
    return css`
      ...
      .header h1{font-size:18px;color: #328CC0;text-transform:uppercase;margin-bottom:0px;}
...
.body {background-image : url('src/img/cross-analysis/Polygon 10.png');background-repeat:no-repeat;    background-position-y: bottom;}
    ...
    return html`
      <mv-card .data="" .position="${position}">
        ...
        <div slot="body" class="body">
          <a href="" class="circle">
            <img src="./src/img/cross-analysis/collect.png" />
          </a>
          <a href="" class="link">
            <img src="./src/img/cross-analysis/Line 1.png" />
            <img
              src="./src/img/cross-analysis/Vector 10.png"
              class="arrow-big"
            />
            <img
              src="./src/img/cross-analysis/Vector 11.png"
              class="arrow-small"
            />
